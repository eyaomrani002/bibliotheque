 ...
 */
final class Version20251117180240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD categorie_id INT NOT NULL, ADD editeur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre DROP categorie_id, DROP editeur_id');
    }
}
